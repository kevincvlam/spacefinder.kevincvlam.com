...
<?php
   ...
   $q1 = findBusynessIndex("Robarts Library", "10", 1); 
   $q2 = findBusynessIndex("Robarts Library", "10", 2); 
   $q3 = findBusynessIndex("Robarts Library", "10", 3); 
   $q4 = findBusynessIndex("Robarts Library", "10", 4);
...
?>
	...
	<map id="triangle" name ="triangle">
		...
		<area shape="poly" title="Quadrant1" href="#1" alt="Quadrant1" coords="347,330, 422,326, 465,401, 430,465, 340,465, 304,403, 347,300" data-maphilight='{<?php echoColour($q4);?>}'/>
		...
		<area shape="poly" title="Quadrant4" href="#4" alt="Quadrant4" coords="47,203, 232,207, 119,312, 47,203" data-maphilight='{<?php echoColour($q1);?>}'/>
	</map>
